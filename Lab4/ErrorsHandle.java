...
public enum ErrorsHandle {
    ...
    CONFIG_ARGS(2, "Not enough arguments in config-file: "),
    INPUT_READ(3, "Not possible to read input file."),
    OUTPUT_WRITE(4, "Not possible to write to output file."),
    REFL_EXEPTION(5, "Reflective exception."),
    LOG_ERROR(6, "Impossible to create log."),
    EX_ERR(7, "Common executor error.");
